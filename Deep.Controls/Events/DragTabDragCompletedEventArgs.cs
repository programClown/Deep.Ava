...
public class DragTabDragCompletedEventArgs : DragTabItemEventArgs
{
    ...
    public DragTabDragCompletedEventArgs(RoutedEvent routedEvent, DragTabItem dragItem,
    ...
    public DragTabDragCompletedEventArgs(RoutedEvent routedEvent, Interactive source, DragTabItem dragItem,
        VectorEventArgs dragCompletedEventArgs)
