...
{
    public static readonly string DefaultFontFamily = "fonts:AlibabaPuHuiTi#Alibaba PuHuiTi 3.0";
    public static Uri Key { get; } = new("fonts:AlibabaPuHuiTi", UriKind.Absolute);
    public static Uri Source { get; } = new("avares://Deep.Ava/Assets/Fonts/AliBaba", UriKind.Absolute);
}
...
{
    public static readonly string DefaultFontFamily = "fonts:HarmonyOS_Sans_SC#HarmonyOS Sans SC";
    public static Uri Key { get; } = new("fonts:HarmonyOS_Sans_SC", UriKind.Absolute);

    public static Uri Source { get; } =
        new("avares://Deep.Ava/Assets/Fonts/HarmonyOS Sans", UriKind.Absolute);
}
