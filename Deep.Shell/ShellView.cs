...
public partial class ShellView : TemplatedControl, INavigationBarProvider
{
    ...
    public NavigationBar? AttachedNavigationBar { get; private set; }

    public StackContentView? ContentView { get; private set; }
    ...
    public static readonly StyledProperty<IPageTransition?> DefaultPageTransitionProperty =
        AvaloniaProperty.Register<ShellView, IPageTransition?>(
            ...
            PlatformSetup.TransitionForPage);
    ...
    public static readonly StyledProperty<IPageTransition?> ModalPageTransitionProperty =
        AvaloniaProperty.Register<ShellView, IPageTransition?>(
            ...
            PlatformSetup.TransitionForModal);
    ...
    public static readonly StyledProperty<NavigationBarAttachType> NavigationBarAttachTypeProperty =
        AvaloniaProperty.Register<ShellView, NavigationBarAttachType>(
            ...
            PlatformSetup.NavigationBarAttachType);
    ...
    public static readonly StyledProperty<bool> EnableSafeAreaProperty =
        AvaloniaProperty.Register<ShellView, bool>(nameof(EnableSafeArea), true);
    ...
    public static readonly StyledProperty<bool> ApplyTopSafePaddingProperty =
        AvaloniaProperty.Register<NavigationBar, bool>(nameof(ApplyTopSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyBottomSafePaddingProperty =
        AvaloniaProperty.Register<NavigationBar, bool>(nameof(ApplyBottomSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyLeftSafePaddingProperty =
        AvaloniaProperty.Register<NavigationBar, bool>(nameof(ApplyLeftSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyRightSafePaddingProperty =
        AvaloniaProperty.Register<NavigationBar, bool>(nameof(ApplyRightSafePadding), true);
    ...
    {
        return element.GetValue(EnableSafeAreaForTopProperty);
    }
    ...
    {
        return element.GetValue(EnableSafeAreaForBottomProperty);
    }
    ...
    {
        return element.GetValue(EnableSafeAreaForLeftProperty);
    }
    ...
    {
        return element.GetValue(EnableSafeAreaForRightProperty);
    }
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        AttachedNavigationBar = e.NameScope.Find<NavigationBar>("PART_NavigationBar");
        ContentView = e.NameScope.Find<StackContentView>("PART_ContentView");
    ...
    private void SetupUi()
    {
        ...
        if (_splitView != null) _splitView.PaneClosing += SplitViewOnPaneClosing;

        if (_sideMenu != null) _sideMenu.Items = _sideMenuItems;
    }
    ...
    private void SetupNavigationBar()
    {
        if (_navigationBarPlaceHolder != null &&
            ...
            AttachedNavigationBar == null)
            _navigationBarPlaceHolder.Content = AttachedNavigationBar = new NavigationBar(this);
    }
    ...
    {
        if (NavigationBarAttachType == NavigationBarAttachType.ToShell) return AttachedNavigationBar;
    ...
    {
        await (ContentView?.PushViewAsync(view, navigateType, cancellationToken) ?? Task.CompletedTask);
    ...
    public async Task RemoveViewAsync(object view,
        ...
        CancellationToken cancellationToken = default)
    {
        await (ContentView?.RemoveViewAsync(view, navigateType, cancellationToken) ?? Task.CompletedTask);
    ...
    {
        await (ContentView?.ClearStackAsync(cancellationToken) ?? Task.CompletedTask);
    ...
    {
        return _modalView?.PushViewAsync(instance, navigateType, cancellationToken) ?? Task.CompletedTask;
    }
    ...
    {
        var view = ContentView?.CurrentView;
