...
public class NavigationBar : TemplatedControl
{
    ...
    public static readonly StyledProperty<double> PlatformHeightProperty =
        AvaloniaProperty.Register<NavigationBar, double>(nameof(PlatformHeight), 36);
    ...
    {
        return element.GetValue(HeaderIconProperty);
    }
    ...
    public static readonly AttachedProperty<bool> VisibleProperty =
        AvaloniaProperty.RegisterAttached<NavigationBar, AvaloniaObject, bool>("Visible", true);
