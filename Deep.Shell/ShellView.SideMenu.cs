...
public partial class ShellView
{
    ...
    public static readonly StyledProperty<double> DefaultSideMenuSizeProperty =
        AvaloniaProperty.Register<ShellView, double>(nameof(DefaultSideMenuSize), 250);

    public double DefaultSideMenuSize
    {
        get => GetValue(DefaultSideMenuSizeProperty);
    ...
    {
        return element.GetValue(OverrideSideMenuBehaveProperty);
    }
