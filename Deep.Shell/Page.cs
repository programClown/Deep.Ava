...
public class Page : UserControl, INavigationLifecycle, INavigatorLifecycle, INavigationBarProvider
{
    ...
    public static readonly StyledProperty<bool> ApplyTopSafePaddingProperty =
        AvaloniaProperty.Register<Page, bool>(nameof(ApplyTopSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyBottomSafePaddingProperty =
        AvaloniaProperty.Register<Page, bool>(nameof(ApplyBottomSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyLeftSafePaddingProperty =
        AvaloniaProperty.Register<Page, bool>(nameof(ApplyLeftSafePadding), true);
    ...
    public static readonly StyledProperty<bool> ApplyRightSafePaddingProperty =
        AvaloniaProperty.Register<Page, bool>(nameof(ApplyRightSafePadding), true);
    ...
    public static readonly StyledProperty<bool> IsModalProperty =
        AvaloniaProperty.Register<ToggleButton, bool>(nameof(IsModal));
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            if (Shell != null) this[!SafePaddingProperty] = Shell[!ShellView.SafePaddingProperty];
        }
    ...
    {
        if (_navigationBarPlaceHolder == null || AttachedNavigationBar != null)
            return;
